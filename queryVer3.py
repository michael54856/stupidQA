    ...
    for question in questions:
        ...
        for answer in answerList:
            ...
            for word in wordList:
                ...
                if len(compareList) == 0 or len(answerCountList) == 0:
                    continue

                if math.log10(len(answerCountList)) == 0:
                    intersectionScore += ((intersectionCount*len(answer))/len(compareList))
                else:
                    intersectionScore += ((intersectionCount*len(answer))/len(compareList)/math.log10(len(answerCountList)))
